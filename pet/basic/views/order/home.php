...
<table class="table">
 ...
 <?php foreach ($cartItems as $item) : ?>
            ...
            <td><?= Yii::$app->formatter->asDecimal($item->product->product_price * $item->quantity, 0) ?> VND</td>
                    ...
                    <td><?= Html::a('Cập nhật', ['order/updatecart','item_id' => $item->id], ['class' => 'btn btn-success','style' => 'width: 100px;']) ?>
</td>
                    <td><?= Html::a('Xóa', ['order/clear','item_id' => $item->id], ['class' => 'btn btn-danger','style' => 'width: 100px;']) ?>
</td>
